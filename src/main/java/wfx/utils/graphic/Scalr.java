 ...
 * between the two depending on the scaling hint provided (see {@link wfx.utils.graphic.Scalr.Method}).
 * <p/>
 ...
 * better, especially when using the {@link wfx.utils.graphic.Scalr.Method#ULTRA_QUALITY} method.
 * <p/>
 * Only when scaling using the {@link wfx.utils.graphic.Scalr.Method#AUTOMATIC} method will this class
 * look at the size of the image before selecting an approach to scaling the
 * image. If {@link wfx.utils.graphic.Scalr.Method#QUALITY} is specified, the best-looking algorithm
 ...
 * the original image unless a mode of {@link wfx.utils.graphic.Scalr.Mode#FIT_EXACT} is specified; in
 ...
 * <p/>
 * When not using {@link wfx.utils.graphic.Scalr.Mode#FIT_EXACT}, in order to maintain the
 ...
 * <li>If a {@link wfx.utils.graphic.Scalr.Mode} value of {@link wfx.utils.graphic.Scalr.Mode#FIT_TO_WIDTH} or
 * {@link wfx.utils.graphic.Scalr.Mode#FIT_TO_HEIGHT} is passed in to the <code>resize</code> method,
 ...
 * <h3>Thread Safety</h3>
 * The {@link wfx.utils.graphic.Scalr} class is <strong>thread-safe</strong> (as all the methods
...
public class Scalr {
	...
	public static enum Method {
		 ...
		 * {@link wfx.utils.graphic.Scalr#THRESHOLD_QUALITY_BALANCED} or
		 * {@link wfx.utils.graphic.Scalr#THRESHOLD_BALANCED_SPEED} thresholds as cut-offs to
		 ...
		 * beyond the work done by {@link wfx.utils.graphic.Scalr.Method#QUALITY} to make the image look
		 ...
		 * jagged with some of the other {@link wfx.utils.graphic.Scalr.Method}s (even
		 * {@link wfx.utils.graphic.Scalr.Method#QUALITY}).
		 */
		ULTRA_QUALITY;
	}
	...
	public static enum Mode {
		 ...
		 * 
		 * See "Image Proportions" in the {@link wfx.utils.graphic.Scalr} class description for
		 * more detail.
		 */
		AUTOMATIC,
		/**
		 ...
		 * modes or {@link wfx.utils.graphic.Scalr.Mode#AUTOMATIC} if you want the image to look
	 ...
	 * {@link wfx.utils.graphic.Scalr.Method#AUTOMATIC} method will decide if a {@link wfx.utils.graphic.Scalr.Method#BALANCED}
	 * method will be used (if smaller than or equal to threshold) or a
	 * {@link wfx.utils.graphic.Scalr.Method#SPEED} method will be used (if larger than threshold).
	 * <p/>
	 ...
	 * size need to use a {@link wfx.utils.graphic.Scalr.Method#BALANCED} scale method to look decent in
	 * most all cases while using the faster {@link wfx.utils.graphic.Scalr.Method#SPEED} method for
	...
	/**
	 * Threshold (in pixels) at which point the scaling operation using the
	 * {@link wfx.utils.graphic.Scalr.Method#AUTOMATIC} method will decide if a {@link wfx.utils.graphic.Scalr.Method#QUALITY}
	 * method will be used (if smaller than or equal to threshold) or a
	 * {@link wfx.utils.graphic.Scalr.Method#BALANCED} method will be used (if larger than threshold).
	 * <p/>
	 * The bigger the image is being scaled to, the less noticeable degradations
	 * in the image becomes and the faster algorithms can be selected.
	 * <p/>
	 ...
	 * testing between different types of images scaled with this library; both
	 * photographs and screenshots. It was determined that images below this
	 * size need to use a {@link wfx.utils.graphic.Scalr.Method#QUALITY} scale method to look decent in
	 * most all cases while using the faster {@link wfx.utils.graphic.Scalr.Method#BALANCED} method for
	 * images bigger than this threshold showed no noticeable degradation over a
	 ...
	 * <p/>
	 * A scaling method of {@link wfx.utils.graphic.Scalr.Method#AUTOMATIC} and mode of
	 * {@link wfx.utils.graphic.Scalr.Mode#AUTOMATIC} are used.
	 * <p/>
	 * <strong>TIP</strong>: This operation leaves the original <code>src</code>
	 * image unmodified. If the caller is done with the <code>src</code> image
	 * after getting the result of this operation, remember to call
	 ...
	 * <p/>
	 * A mode of {@link wfx.utils.graphic.Scalr.Mode#AUTOMATIC} is used.
	 * <p/>
	 * <strong>TIP</strong>: This operation leaves the original <code>src</code>
	 * image unmodified. If the caller is done with the <code>src</code> image
	 * after getting the result of this operation, remember to call
	 ...
	 *             operations.
	 * 
	 * @see wfx.utils.graphic.Scalr.Method
	 */
	 ...
	 * the given WIDTH or HEIGHT explicitly, depending on the {@link wfx.utils.graphic.Scalr.Mode}
	 * specified) and apply the given {@link java.awt.image.BufferedImageOp}s (if any) to the
	 * result before returning it.
	 * <p/>
	 * A scaling method of {@link wfx.utils.graphic.Scalr.Method#AUTOMATIC} is used.
	 * <p/>
	 * <strong>TIP</strong>: This operation leaves the original <code>src</code>
	 * image unmodified. If the caller is done with the <code>src</code> image
	 * after getting the result of this operation, remember to call
	 ...
	 *            given width ({@link wfx.utils.graphic.Scalr.Mode#FIT_TO_WIDTH}) or fitting the image
	 *            to the given height ({@link wfx.utils.graphic.Scalr.Mode#FIT_TO_HEIGHT}). If
	 *            {@link wfx.utils.graphic.Scalr.Mode#AUTOMATIC} is passed in, imgscalr will calculate
	 ...
	 *            want to use {@link wfx.utils.graphic.Scalr.Mode#AUTOMATIC} to "do the right thing".
	 * @param targetSize
	 *            The target width and height (square) that you wish the image
	 *            to fit within.
	 * @param ops
	 ...
	 *             operations.
	 * 
	 * @see wfx.utils.graphic.Scalr.Mode
	 */
	 ...
	 * explicitly, depending on the {@link wfx.utils.graphic.Scalr.Mode} specified) and apply the given
	 * {@link java.awt.image.BufferedImageOp}s (if any) to the result before returning it.
	 * <p/>
	 * A scaling method of {@link wfx.utils.graphic.Scalr.Method#AUTOMATIC} is used.
	 * <p/>
	 ...
	 * Resize a given image (maintaining its original proportion) to the target
	 * width and height (or fitting the image to the given WIDTH or HEIGHT
	 * explicitly, depending on the {@link wfx.utils.graphic.Scalr.Mode} specified) using the given
	...
	/**
	 * Used to apply a {@link wfx.utils.graphic.Scalr.Rotation} and then <code>0</code> or more
	 ...
	 *             operations.
	 * 
	 * @see wfx.utils.graphic.Scalr.Rotation
	 */
	 ...
	 * {@link wfx.utils.graphic.Scalr#DEBUG} is <code>true</code>; otherwise the VM will be
	 ...
	 * 
	 * @see wfx.utils.graphic.Scalr#LOG_PREFIX
	 * @see wfx.utils.graphic.Scalr#LOG_PREFIX_PROPERTY_NAME
	 */
	...
	/**
	 * Used to determine the scaling {@link wfx.utils.graphic.Scalr.Method} that is best suited for
	 * scaling the image to the targeted dimensions.
	 * <p/>
	 * This method is intended to be used to select a specific scaling
	 * {@link wfx.utils.graphic.Scalr.Method} when a {@link wfx.utils.graphic.Scalr.Method#AUTOMATIC} method is specified. This
	 * method utilizes the {@link wfx.utils.graphic.Scalr#THRESHOLD_QUALITY_BALANCED} and
	 * {@link wfx.utils.graphic.Scalr#THRESHOLD_BALANCED_SPEED} thresholds when selecting which
	 ...
	 * 
	 * @return the fastest {@link wfx.utils.graphic.Scalr.Method} suited for scaling the image to the
