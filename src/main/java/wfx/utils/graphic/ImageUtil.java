...
public class ImageUtil {
     ...
     * @param maxWidth
     * @param maxHeight
     * @param type      1: jpg 2: png 4: gif 3: jpg+png 5: jpg+gif 6: png+gif 7:
     *                  jpg+png+gif
    ...
    public static void resizeJpg(InputStream in, OutputStream out, int maxWidth, int maxHeight, float quality) throws IOException {
        checkParams(in, out, maxWidth, maxHeight, quality);
        //
        BufferedImage image = ImageIO.read(in);
        image = Scalr.resize(image, Scalr.Method.AUTOMATIC, Scalr.Mode.FIT_EXACT, maxWidth, maxHeight);
    ...
    public static void main(String[] args) throws IOException {
        FileInputStream in = new FileInputStream(new File("d:\\tmpPhoto\\photo\\fx_2014_05_03\\DSC_3460.JPG"));
        FileOutputStream out = new FileOutputStream(new File("d:\\tmpPhoto\\photo\\fx_2014_05_03\\DSC_3460_1.JPG"));
        try {
            resizeJpg(in, out, 8, 8, 1f, null, FONT, Color.darkGray);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            out.close();
